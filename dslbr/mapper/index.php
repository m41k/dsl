...
$_SESSION["autenticagd"]=rand(100000,999999);
$_SESSION["sessao"]=1;
}
?>
<html>
...
//verifica /(barras) inicio e fim campo caminho
if (($_POST['caminho']{0} != '/') or ($_POST['caminho']{strlen($_POST['caminho'])-1} != '/')){
 $erro = "Caminho invalido, necessita / (barra) inicio e fim do caminho. Ex: /usr/local/bin/ ";
 }else{
...
<form method='POST' enctype='multipart/form-data'>
    ...
    <br>
    Codigo:
    <br><input type='text' name='confirmacao'>&nbsp;<img src='gd.php'>
    <br>
    <br>
